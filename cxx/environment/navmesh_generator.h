...
class NavMeshGenerator {
  ...
  private:
     ...
     */
    static void generateNodePolygons(const Node &node, const NodeGeometry &geom, NavMesh &navmesh,
     ...
     */
    static void generateEdgePolygons(const Edge &edge, const EdgeGeometry &geom, NavMesh &navmesh,
     ...
     */
    static NavPolygon createRectPolygon(int id,
     ...
     */
    static std::vector<std::pair<double, double>> getEdgeWalkableCorners(const EdgeGeometry &geom,
                                                                         double clearWidth);
};
