...
public:
    ...
    int getPolygonId() const noexcept { return polygonId; }
    ...
    int getAssociatedNodeId() const noexcept { return associatedNodeId; }
    int getAssociatedEdgeId() const noexcept { return associatedEdgeId; }
    void setAssociatedNodeId(int nodeId) noexcept { associatedNodeId = nodeId; }
    void setAssociatedEdgeId(int edgeId) noexcept { associatedEdgeId = edgeId; }

    // Neighbor connections (indices into NavMesh polygon array)
    const std::vector<int>& getNeighbors() const noexcept { return neighbors; }
    ...
    // Walkability
    bool isWalkable() const noexcept { return walkable; }
    void setWalkable(bool w) noexcept { walkable = w; }
...
public:
    ...
    const NavPolygon& getPolygon(int index) const { return polygons.at(static_cast<size_t>(index)); }
    NavPolygon& getPolygon(int index) { return polygons.at(static_cast<size_t>(index)); }
    int getPolygonCount() const noexcept { return static_cast<int>(polygons.size()); }
